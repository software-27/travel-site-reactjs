...
import SearchDate3 from "components/SearchDate3/index";
import Inventory2 from "components/Inventory2/index";
import Flag from "components/Flag/index";
import FieldsCardBtn from "components/FieldsCardBtn/index";
import SearchDate4 from "components/SearchDate4/index";
import Manager from "components/Manager/index";
import FieldsReferralBtn from "components/FieldsReferralBtn/index";


const ReportReferrals = ()=> {
 /* const handleshow = (e) => {
      ...
      <Column className="bg-white w-[100%]">
        ...
        <Row className="w-[100%] mt-[8px]">
          ...
          <Column className="p-2 bg-white h-auto w-[100%]">
                ...
                <Text className="text-[15px] ml-2 mt-2 text-[#667E99]">Referrals</Text>
              </Row>
                </Row>
                              ...
                              <div class="border border-[#E7E7E7] p-[200px]">
                                <Column className="items-center">
                                  <Text className="mb-5 text-gray-400">
                                    No searches saved for Referrals
                                  </Text>
