...
import FieldsInventoryBtn from "components/FieldsInventoryBtn/index";
      ...
      <Column className="bg-white w-[100%]">
        ...
        <Row className="w-[100%] mt-[8px]">
          ...
          <Column className="p-2 bg-white h-auto w-[100%]">
                ...
                <Text className="text-[15px] ml-2 mt-2 text-[#667E99]">Inventory</Text>
              </Row>
                </Row>
                ...
                <Row>
                  ...
                  <Row className="items-center gap-4 h-9 mt-1 w-[49%]">
                      <Inventory className="w-[50%]" />
                  </Row>
