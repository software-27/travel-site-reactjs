          ...
          <Column className="p-2 bg-white h-auto w-[100%]">
                    ...
                    <Row className="justify-end gap-2">
                      ...
                      <Row className="gap-2 items-center">
                        <Icon path={mdiPlusThick}
                          ...
                          color="white"
                        />
                        <Text className="text-lg">Create Contact</Text>
                      </Row>
                      </Button>
              ...
              <Row>
                <Column className="justify-center items-center m-10 w-[45%]">
                  ...
                  Add your customers as contacts to keep track of their details
                  and bookings, and to easily assign them to new bookings.
                  </Row>
                ...
                <Column className="justify-center w-[70%]">
                  <Img src="images/contacts.svg" className="h-[70%] w-[70%]" />
                </Column>
              </Row>
            </Column>
                </Row>
