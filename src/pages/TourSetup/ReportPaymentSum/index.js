...
import TransactionSource from "components/TransactionSource/index";
import FieldsPaymnetsumBtn from "components/FieldsPaymentsumBtn/index";

 
const ReportPaymentSum = ()=> {
 /* const handleshow = (e) => {
      ...
      <Column className="bg-white w-[100%]">
        ...
        <Row className="w-[100%] mt-[8px]">
          ...
          <Column className="p-2 bg-white h-auto w-[100%]">
                ...
                <Text className="text-[15px] ml-2 mt-2 text-[#667E99]">Payment Summary</Text>
              </Row>
                </Row>
                ...
                <Row>
                  ...
                  <Row className="items-center gap-4 h-9 w-[100%]">
                    ...
                    <TransactionSource className="w-[50%]" />
                  </Row>
                              ...
                              <div class="border border-[#E7E7E7] p-[200px]">
                                <Column className="items-center">
                                  <Text className="mb-5 text-gray-400">
                                    No searches saved for Payment Summary
                                  </Text>
...
export default ReportPaymentSum;
