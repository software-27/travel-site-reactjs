...
//                               <Column>
//                                 <Row >
//                                   <Text className="mr-2 xl:w-[60px] text-right">
//                                     Name
//                                   </Text>
//                                   <textarea id="message" 
//                                     rows="1" 
//                                     class="2xl:ml-[42px] block placeholder-gray-500 p-2.5 w-full resize-none text-sm text-gray-900 bg-white border border-gray-300 focus:ring-[#ed8709] focus:border-[#ed8709] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-[50%]" 
...
//                                   </Text>
//                                   <select
//                                     class="2xl:ml-[-10px] xl:ml-[0] block placeholder-gray-500 p-2.5 w-full resize-none text-sm text-gray-900 bg-white border border-gray-300 focus:ring-[#ed8709] focus:border-[#ed8709] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-[50%]" 
//                                     >
