...
import DropdownRender1 from "components/DropdownOtherOp/index";
                    ...
                    <Column className="bg-white h-auto w-[100%]">
                        ...
                        <Row className="mb-4">
                            <Column className="w-[65%] text-light_blue_600 text-[25px] m-1 font-light">
                                <Row className="">
                                    <Text>Option 2 of 2</Text>
                                    <Button class="cursor-pointer items-center h-fit py-2.5 px-3 ml-4 text-sm font-medium text-white bg-[#428BCA] hover:bg-[#6FB3E0] ring-2 ring-[#428BCA] ring-inset"
                                        size="xs"
                                        type="submit"
                                    ...
                                    <Button class="items-center h-fit py-2.5 px-3 ml-0.5 cursor-not-allowed text-sm font-medium text-white bg-[#A0A0A0]"
                                        size="xs"
                                        type="submit">
