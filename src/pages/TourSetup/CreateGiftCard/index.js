...
const CreateGiftCard = () => {
  ...
  //button navigate back to giftcard
          ...
          <Column className="p-2 bg-white h-auto w-[100%]">
                  ...
                  <Button onClick={handleNavigate1} class=" bg-[#4C8FBD] hover:bg-[#006BB8] items-center h-fit py-2.5 px-3 mr-2 text-sm font-medium text-white ring-4 ring-[#4C8FBD] ring-inset"
                    ...
                    <Row className="gap-2 items-center">
                      <Icon path={mdiCheck}
                        ...
                        color="white"
                      />
                      <Text className="text-lg cursor-pointer">Create Gift Card</Text>
                    </Row>
                  </Button>
                ...
                <div className="space-y-3">
                  <Row className="space-x-3 items-center">
                    ...
                    <input
                      ...
                      size="smSrc"
                      required
                      placeholder="Card Number (Will be generated if left blank)"
                    ></input>
                  </Row>
            ...
            <Row className="mt-4">
              <Column className="w-[50%] m-2 font-regular">
                <Text className="text-[20px] font-light ">Billing Information</Text>
              ...
              <Column className="ml-4 w-[50%] m-2 font-regular">
                <Text className="text-[20px] font-light ">Card Details</Text>
                <Line className="bg-gray_700_33 mb-[10px] h-[1.0px] w-[100%]"></Line>
                <div className="space-y-3">
                    <Text>This is the starting value of this gift card. This amount is not charged to the customer.</Text>
                  <Row className="items-center space-x-3">
                    <Text className="text-[#667E99] w-[20%] text-right">
                      Card Value
                    </Text>
                    <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block h-8 w-[40%]  "
                      type="text"
                      size="smSrc"
                      required
                      placeholder="RM "
                  ...
                  <Row className="items-center space-x-3">
                    ...
                    <input
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block h-8 w-[40%]  "
                      type="text"
                      size="smSrc"
                      required
            ...
            <div className="mr-3">
              <input
                className="bg-gray-50 border border-gray-300 justify-start text-gray-900 text-sm focus:ring-blue-500 focus:border-[#e2711d] block w-[100%]"
                type="text"
                size="smSrc"
                required
                placeholder="Tour"
