                                ...
                                <Row>
                                    ...
                                    <Column className="w-[50%]">
                                        ...
                                        {showModal2 ? (
                                            <>
                                                <div
                                                    className="justify-center items-center mx-[200px] my-[120px] flex-nowrap overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
                                                >
                                                    {/*Header*/}
                                                    <Column classname="w-[100%]">
                                                        <Row className="bg-[#428BCA] w-[100%] items-start justify-between">
                                                            <Text className="pl-3 py-5 text-xl text-white font-light">
                                                                Activate Rezgo Account
                                                            </Text>
                                                    ...
                                                    <Column className="bg-white w-[100%]">
                                                        <Row >
                                                            <Column className="w-[50%]">
                                                                <Row className="mt-2">
                                                                    <Text className="pt-1 mt-2 text-[14px] ml-3 text-[#667E99] w-[15%] text-right ">
                                                                        Company
                                                                    </Text>
                                                                    <input
                                                                        className="placeholder-[#d5d5d5] mx-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block h-8 w-[100%] 2xl:mt-2 "
                                                                        type="text"
                                                                        size="smSrc"
                                                                        required
                                                                ...
                                                                <Row>
                                                                    <Text className="pt-1 mt-2 mb-[90px] text-[14px] ml-3 text-[#667E99] w-[15%] text-right ">
                                                                        Postal
                                                                    </Text>
                                                                    <input
                                                                        className="placeholder-[#d5d5d5] mx-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block h-8 w-[100%] 2xl:mt-2 "
                                                            ...
                                                            <Column className="w-[50%]">
                                                                {/* <div className=" mt-4 items-center justify-start p-3 border-t border-solid border-slate-200 bg-[#EFF3F8] ml-3 mr-3 "> */}

                                                                <Text className="text-xl text-black font-light">
                                                                    Secure Form
                                                                </Text>

                                                                <Text className=" text-[14px] ml-3 text-[#667E99] ">
                                                                ...
                                                                <Row className=" mt-6 ml-3 flex items-center justify-start p-3 border-t border-solid border-slate-200 bg-[#EFF3F8] mr-3 ">
                                                                    <button
