...
import {  mdiEyeOff, mdiPencil, mdiWaterOutline, mdiFileDocumentOutline, mdiTagOutline, mdiTicketOutline } from '@mdi/js';
                            ...
                            >
                                <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[45%]">
                                    <Row className="items-center gap-2">
                                        ...
                                        />
                                        <Text className="text-sm mt-1">HalalHoliday CSS Styles</Text>
                                    </Row>
                                </th>
                            ...
                            >
                                <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[45%]">
                                    <Row className="items-center gap-2">
                                        ...
                                        />
                                        <Text className="text-sm mt-1">Per-Booking Ticket</Text>
                                    </Row>
                                </th>
                                <td class="py-2 w-[20%] text-[13px] text-black ">
                            ...
                            >
                                <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[45%]">
                                    <Row className="items-center gap-2">
                                        ...
                                        />
                                        <Text className="text-sm mt-1">Per-Guest Tickets</Text>
                                    </Row>
                                </th>
                                <td class="py-2 w-[20%] text-[13px] text-black ">
                            ...
                            >
                                <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[45%]">
                                    <Row className="items-center gap-2">
                                        ...
                                        />
                                        <Text className="text-sm mt-1">Merchandise Voucher</Text>
                                    </Row>
                                </th>
                                <td class="py-2 w-[20%] text-[13px] text-black ">
