...
import { mdiLock, mdiEyeOff, mdiPencil, mdiCircleOutline, mdiLaptop, mdiCellphone } from '@mdi/js';
                            ...
                            >
                                <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[45%]">
                                    <Row className="items-center gap-2">
                                        ...
                                        />
                                        <Text className="text-sm mt-1">Full Site Template</Text>
                                    </Row>
                                </th>
                            ...
                            >
                                <th scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white w-[45%]">
                                    <Row className="items-center gap-2">
                                        ...
                                        />
                                        <Text className="text-sm mt-1">Mobile Site Template</Text>
                                    </Row>
                                </th>
                                <td class="py-2 w-[20%] text-[13px] text-black ">
