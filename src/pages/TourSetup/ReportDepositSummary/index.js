...
import FieldsDepositsumBtn from "components/FieldsDepositsumBtn/index";


const ReportDepositSummary = ()=> {
 /* const handleshow = (e) => {
      ...
      <Column className="bg-white w-[100%]">
        ...
        <Row className="w-[100%] mt-[8px]">
          ...
          <Column className="p-2 bg-white h-auto w-[100%]">
                ...
                <Text className="text-[15px] ml-2 mt-2 text-[#667E99]">Deposit Summary</Text>
              </Row>
                </Row>
...
export default ReportDepositSummary;
