        ...
        <>
            ...
            <div className="w-full font-montserrat bg-[#F5F5F5] h-fit xs:pt-[160px] lg:pt-[92px]" style={{ zIndex: 1 }}>
                ...
                <div className="p-[50px]">
                    ...
                    <div className="grid grid-cols-2 gap-1 flex items-center 2xl:pr-[160px]">
                ...
                <div className="mt-[50px] bg-[#10A6A0] py-[70px] md:px-[50px] 2xl:px-[200px] w-screen">
                    <div>
                ...
                <div className="p-[50px]"> 
                    ...
                    <div>
                        ...
                        <div className="w-[100%] place-items-center grid mt-[90px] px-[50px]">
                            ...
                            <div className="grid grid-cols-2 gap-4 items-center mt-[50px] 2xl:px-[150px]">
                                <div>
                                    <Img
                                        src="images/ss1.png"
                            ...
                            <div className="grid grid-cols-2 gap-4 items-center mt-[30px] 2xl:px-[150px]">
                                <div className="">
                                    <div    >
                                        <text className="md:text-[38px] 2xl:text-[25px] text-[#10A6A0] font-bold">
                    ...
                    <div className="w-[100%] place-items-center grid">
                        <div className="border border-[#00A19A] md:px-[200px] 2xl:px-[390px] place-items-center grid mt-[50px] p-8">
                            <div className=" text-center ">
                                <text className=" md:text-[32px] 2xl:text-[18px] ">
                                    Interested to join our Epic Program?
                                </text>
                            </div>
                            <button className="text-[#FFFFFF] bg-[#00A19A] md:mt-[40px] 2xl:mt-[20px] md:text-[25px] 2xl:text-[15px] md:p-6 2xl:p-3 rounded-lg shadow-md hover:bg-[#45B9B4]">
                                Sign Up Now
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-1 flex items-center mt-[100px] mb-[30px] 2xl:pr-[160px]">
                        <div className="text-right">
                            <text className="md:text-[90px] 2xl:text-[90px] text-[#008D36] font-bold text-right leading-tight">
