...
const selectOptions = [
  { value: "N", label: "New"},
  { value: "FB", label: "Flagged Bookings"},
  { value: "CI", label: "Checked-In"},
  { value: "NCI", label: "Not Checked-In"},
  { value: "NE", label: "Notfication Errors"},
  { value: "R", label: "Received"},
  { value: "P", label: "Pending"},
  { value: "C", label: "Cancelled"},
  { value: "DB", label: "Date-Based"},
  { value: "O", label: "Open"},
  { value: "HR", label: "Has Review"},
  { value: "DNHR", label: "Does Not Have Review"},
  { value: "UR", label: "Unread Review"},
  { value: "RR", label: "Responded Review"},
  { value: "USR", label: "Unresponded Review"},
  { value: "FR", label: "Front End"},
...
const SelectFlag = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
