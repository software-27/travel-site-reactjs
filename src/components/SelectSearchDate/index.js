...
const selectOptions = [
  { value: "option1", label: "Search 'Created On' Date" },
  { value: "option2", label: "Search 'Booked/Used' Date" },
  { value: "option3" , label: "Search 'Status Change' Date" },
  { value: "option4", label: "Search 'Refund Transaction' Date" },
  { value: "option5", label: "Search 'Cancelled' Date" },
];
...
const SelectSearchDate = React.forwardRef(
  (
    {
      children,
      placeholder = "Search 'Status Change' Date",
      className,
