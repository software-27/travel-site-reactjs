...
const selectOptions = [
  { value: "option1", label: "Always Available" },
  { value: "option2", label: "Available on a Single Day" },
  { value: "option3", label: "Available for a Date Range" },
  { value: "option4", label: "Available on Days of the Week" },
  { value: "option5", label: "Available on Specific Days" },
...
const SelectAvailableDt = React.forwardRef(
  (
    {
      children,
...
SelectAvailableDt.defaultProps = {
  placeholder: "Always Available",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
