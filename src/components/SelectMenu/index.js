...
const selectOptions = [
  { value: "option1", label: "À la carte" },
  { value: "option2", label: "American" },
  { value: "option3", label: "Asian" },
  { value: "option4", label: "Buffet" },
  { value: "option5", label: "Continental" },
  { value: "option6", label: "Halal" },
  { value: "option7", label: "Italian" },
  { value: "option8", label: "Kosher" },
  { value: "option9", label: "Non-halal" },
  { value: "option10", label: "Set menu" },
  { value: "option11", label: "Vegan" },
  { value: "option12", label: "Vegetarian" },
