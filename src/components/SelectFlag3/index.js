...
const selectOptions = [
  { value: "option1", label: "Has a Balance" },
  { value: "option2", label: "Does Not Have a Balance" },
  { value: "option3" , label: "Has Been Sent" },
  { value: "option4", label: "Has Not Been Sent" },
];
...
const SelectFlag3 = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
