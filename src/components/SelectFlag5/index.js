...
const selectOptions = [
  ...
  { value: "O", label: "Open"},
  { value: "B", label: "Bookings"},
  { value: "FE", label: "Front End"},
  { value: "BE", label: "Back End"},
  { value: "CP", label: "Contract Pricing"},
  { value: "NCP", label: "Not Contract Pricing"},
  { value: "CT", label: "Converted To"},
  { value: "NCT", label: "Not Converted To"},
  { value: "CF", label: "Converted From"},
];
...
const SelectFlag5 = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
