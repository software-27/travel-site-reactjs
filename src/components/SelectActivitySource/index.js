...
const selectOptions = [
  { value:"", label: "System",  isdisabled: true},  
  { value: "Ad", label: "Admin"},
  { value: "AP", label: "API"},
  { value: "Ar", label: "Archive"},
  { value: "C", label: "Customer"},
  { value: "E", label: "Email"},
  { value: "N", label: "Notfication"},
  { value: "P", label: "Payment"},
  { value: "S", label: "System"},
  { value: "W", label: "Webhook"},
  { value: "U", label: "Users",  isdisabled: true},
  { value: "1", label: "145457"},
];
...
const SelectActivitySource = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
...
SelectActivitySource.propTypes = {
...
SelectActivitySource.defaultProps = {
  placeholder: "Select",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
