...
const selectOptions = [
  { value: "option1", label: "Arabic" },
  { value: "option2", label: "Bengali" },
  { value: "option3", label: "Chinese" },
  { value: "option4", label: "English" },
  { value: "option5", label: "French" },
  { value: "option6", label: "German" },
  { value: "option7", label: "Hindi" },
  { value: "option8", label: "Italian" },
  { value: "option9", label: "Japanese" },
  { value: "option10", label: "Korean" },
  { value: "option11", label: "Lahnda" },
  { value: "option12", label: "Malay" },
  { value: "option13", label: "Marathi" },
  { value: "option14", label: "Persian" },
  { value: "option15", label: "Portugese" },
  { value: "option16", label: "Russian" },
  { value: "option17", label: "Spanish" },
  { value: "option18", label: "Tamil" },
  { value: "option19", label: "Telugu" },
  { value: "option20", label: "Turkish" },
  { value: "option21", label: "Urdu" },
  { value: "option22", label: "Vietnamese" },
];
...
const SelectLanguage = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
