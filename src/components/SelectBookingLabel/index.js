...
const SelectBookingLabel = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
...
SelectBookingLabel.defaultProps = {
  placeholder: "Select",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
