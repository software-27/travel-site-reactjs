...
const [showModal, setShowModal] = React.useState(false);
            ...
            {showModal ? (
                        ...
                        <div
                          ...
                          >
                            ...
                            <div
                                className="ml-8 mx-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block h-80 w-[80%] 2xl:mt-2 ">
                                 <Row className="m-2 ">
                                                                    <div
 ...
 export default FieldsPaymnetsumBtn;