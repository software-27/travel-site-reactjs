...
const selectOptions = [
  { value: "option1", label: "Site Administrator" },
  { value: "option2", label: "Administrator" },
  { value: "option3", label: "Product Manager" },
  { value: "option4", label: "Booking Manager" },  
  { value: "option5", label: "Booking Agent" },
];
...
const SelectGroup = React.forwardRef(
  (
    {
      children,
      placeholder = "145132 (Default Owner)",
      className,
...
SelectGroup.defaultProps = {
  placeholder: "Do Not Assign a Security Group",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
  isMulti: false,
