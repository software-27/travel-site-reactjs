...
import { mdiMenuDown, mdiWalletGiftcard, mdiShopping, mdiRestore } from '@mdi/js';
import { FaBan, FaTimes, FaCheck } from "react-icons/fa";



const DropdownGiftCard = ({ color }) => {
  // dropdown props (
      ...
      <div className="flex flex-wrap">
        <div className="w-full sm:w-6/12 md:w-4/12 px-4">
          <div className="relative inline-flex align-middle w-full">
            <button
              className={
                "items-center h-fit mr-2 py-2.5 px-3 font-medium text-white bg-[#87B87F] hover:bg-[#837A75] ring-4 ring-[#A6A2A2] ring-inset ease-linear transition-all duration-150 " +
                bgColor
              }
              type="button"
              ref={btnDropdownRef}
            ...
            >
              ...
              >
                ...
                <Icon path={mdiShopping}
                        ...
                        color="black"
                      />
                <Text className="pl-2">View Card Template</Text>
              ...
              >
                ...
                <Icon path={mdiWalletGiftcard}
                        ...
                        color="black"
                      />
                <Text className="pl-2">Gift Card Summary</Text>
              ...
              >
                ...
                <Icon path={mdiRestore}
                        ...
                        color="black"
                      />
                <Text className="pl-2">Restore Deleted Card</Text>
