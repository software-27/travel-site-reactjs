...
const SelectSearchDate5 = React.forwardRef(
  (
    {
      children,
      placeholder = "Search 'Created On' Date",
      className,
...
SelectSearchDate5.defaultProps = {
  placeholder: "Search 'Created On' Date",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
