      ...
      <div className="flex flex-wrap">
        <div className="w-full px-4">
          <div className="relative inline-flex align-middle w-full">
            <button
              className={
                "mt-3 items-center h-fit py-2.0 px-3 text-sm font-medium text-white bg-[#4C8FBD] hover:bg-[#006BB8] ring-4 ring-[#4C8FBD] ring-inset ease-linear transition-all duration-150 " +
                bgColor
              }
              size="xs"
              type="button"
            ...
            >
              ...
              >
                ...
                <Icon path={mdiChevronRight}
                                                ...
                                                color="#a0a0a0"
                                            />
                <Text className="pl-2 text-[#a0a0a0]">Option 1 - 3D1N (2A)</Text>
              ...
              >
                ...
                <Text className="pl-2">Option 2 - 3D1N (2A1C)</Text>
...
export default function DropdownRender2() {
  return (
    <>
      <DropdownOtherOp2 color="white" />
    </>
  );
}