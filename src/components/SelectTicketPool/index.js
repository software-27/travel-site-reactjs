...
const selectOptions = [
  { value: "option1", label: "Don't use a Ticket Pool" },
  { value: "option2", label: "Penang Tour Ticket (5 IDs)" },
];
...
const SelectTicketPool = React.forwardRef(
  (
    {
      children,
      placeholder = "Don't use a Ticket Pool",
      className,
