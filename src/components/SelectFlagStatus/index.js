...
const selectOptions = [
  { value: "option1", label: "Checked-In" },
  { value: "option2", label: "Not Checked-In" },
  { value: "option3" , label: "Received" },
  { value: "option4", label: "Pending" },
  { value: "option5", label: "Contract Pricing" },
  { value: "option6", label: "Not Contract Pricing" },
  { value: "option7", label: "Converted To" },
  { value: "option8", label: "Not Converted To" },
  { value: "option9", label: "Converted From" },
];
...
const SelectFlagStatus = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
