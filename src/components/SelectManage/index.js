...
const selectOptions = [
  { value: "option1", label: "Sort Inventory Items" },
  { value: "option2", label: "Edit Form Library" },
  { value: "option3", label: "Download Inventory CSV" },
  { value: "option4", label: "Restore Deleted Inventory" },
];
...
const SelectManage = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
