...
const selectOptions = [
  { value: "option1", label: "Set Automatically" },
  { value: "option2", label: "Set to Received" },
  { value: "option3", label: "Set to Pending" },
];
...
const SelectSetStatus = React.forwardRef(
  (
    {
      children,
...
SelectSetStatus.defaultProps = {
  placeholder: "Set Automatically",
  className: "",
  isSearchable: false,
  placeholderClassName: "RM",
  isMulti: false,
  value: "",
  shape: "",
