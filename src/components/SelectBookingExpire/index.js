...
const selectOptions = [
  { value: "option1", label: "Never" },
  { value: "option2", label: "A number of days after purchase" },
  { value: "option3", label: "On a specific date" },
];
...
const SelectBookingExpire = React.forwardRef(
  (
    {
      children,
      placeholder = "Never",
...
SelectBookingExpire.defaultProps = {
  placeholder: "Never",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
