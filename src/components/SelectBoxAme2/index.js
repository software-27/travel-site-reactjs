...
const selectOptions = [
  { value: "1", label: "Up to 12 years old" },
  { value: "2", label: "Up to 16 years old" },
  { value: "3", label: "Up to 6 years old" },
];
...
const SelectBoxAme2 = React.forwardRef(
  (
    {
      children,
      placeholder = "Up to 12 years old",
      className,
