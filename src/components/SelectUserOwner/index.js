...
const selectOptions = [
  { value: "option1", label: "Current User" },
  { value: "option2", label: "abc@gmail.com" },
];
...
const SelectUserOwner = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
