...
const selectOptions = [
  ...
  { value: "option2", label: "Search 'Last Used' Date" },
  { value: "option3", label: "Search 'Expires On' Date" },
];
...
const SelectSearchDate3 = React.forwardRef(
  (
    {
      children,
...
SelectSearchDate3.defaultProps = {
  placeholder: "Search 'Created On' Date",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
