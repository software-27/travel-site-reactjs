...
const selectOptions = [
  { value: "option1", label: "Days before event" },
  { value: "option2", label: "Hours before event" },
];
...
const SelectCutoff = React.forwardRef(
  (
    {
      children,
      placeholder = "Hours",
