...
const selectOptions = [
  ...
  { value: "option2", label: "Search 'Earned' Date" },
];
...
const SelectSearchDate4 = React.forwardRef(
  (
    {
      children,
      placeholder = "Search 'Earned' Date",
      className,
...
SelectSearchDate4.defaultProps = {
  placeholder: "Search 'Earned' Date",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
