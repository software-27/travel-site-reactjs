...
const selectOptions = [
  { value: "N", label: "Front End"},
  { value: "FB", label: "Back End"},
  { value: "CI", label: "Successful Transactions"},
  { value: "NCI", label: "Failed Transactions"},
  { value: "NE", label: "Charges"},
  { value: "R", label: "Refunds"},
  { value: "P", label: "Include Order Payments"},
];
...
const SelectFlag4 = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
