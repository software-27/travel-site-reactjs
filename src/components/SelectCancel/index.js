...
const selectOptions = [
  { value: "option1", label: "Hours before event" },
  { value: "option2", label: "Days before event" },
];
...
const SelectCancel = React.forwardRef(
  (
    {
      children,
