...
const selectOptions = [
  { value: "option1", label: "Front-end" },
  { value: "option2", label: "Back-end" },
...
const  SelectTransactionSce = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
...
SelectTransactionSce.propTypes = {
...
SelectTransactionSce.defaultProps = {
  placeholder: "Select",
  className: "",
  isSearchable: false,
  placeholderClassName: "",
